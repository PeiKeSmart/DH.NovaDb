...
public class TableSchema
{
    ...
    private readonly Dictionary<String, Int32> _columnIndexes = new(StringComparer.OrdinalIgnoreCase);
    ...
    /// <summary>下一个自增主键值（仅在内存中维护，重启后由表数据初始化）</summary>
    internal Int64 NextAutoIncrement;
